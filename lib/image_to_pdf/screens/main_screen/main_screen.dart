...
import 'package:lets_chat/image_to_pdf/screens/exit_screen/exit_screen.dart';
import 'package:lets_chat/image_to_pdf/widgets/select_image_card/select_image_card.dart';
          ...
          onTap: () async {
            if (data.fileList.isNotEmpty) {
              await ImageToPdf.imageList(listOfFiles: data.fileList)
                ...
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> const ExitScreen()));
